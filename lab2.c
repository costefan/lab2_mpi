...
#include<mpi.h>
#define DIMENSION 5
#define NUM_ROWS_A DIMENSION //rows of input [A]
#define NUM_COLUMNS_A DIMENSION //columns of input [A]
#define NUM_ROWS_B DIMENSION //rows of input [B]
#define NUM_COLUMNS_B DIMENSION //columns of input [B]
